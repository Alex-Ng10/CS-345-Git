...
/**
 * A Calculator that calculates the weighted total of a List of LabeledNumber objects.
 *
...
public class WeightedTotalCalculator extends WeightedAverageCalculator
{
   ...
   * Notes:
   * 
   * (1) If the Map of weights is null then all weights are equal (i.e., 1). (2) If there is no
   * weight associated with a particular label then a weight of 0 is used. (3) Missing LabeledDouble
   * values are ignored. (4) If the List is null then this method throws a SizeException.
   * 
   * @param resultLabel
