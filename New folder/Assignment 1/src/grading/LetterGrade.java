 ...
 * 
 * This enum represents the common letter grades used in an academic setting, along with their
 * corresponding grade points on a 4.0 scale.
 * 
 * @author Alex Nguyen
 */
public enum LetterGrade
{
  F("F", 0.0), DMINUS("D-", 0.7), D("D", 1.0), DPLUS("D+", 1.3), CMINUS("C-", 1.7), C("C",
      2.0), CPLUS("C+",
          2.3), BMINUS("B-", 2.7), B("B", 3.0), BPLUS("B+", 3.3), AMINUS("A-", 3.7), A("A", 4.0);
   ...
   * 
   * @param label
   *          The label representing the letter grade (e.g., "A", "B+").
   * @param points
   *          The grade points associated with the letter grade.
   */
   ...
   * 
   * @param code
   *          The string code representing the grade (e.g., "A", "B+").
