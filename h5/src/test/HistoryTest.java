...
class HistoryTest
{
  ...
  LeafLabeledDouble testBelow;
  LeafLabeledDouble testEqual;
  LeafLabeledDouble testAbove;
  History historyTest;
  ...
  public void setUp()
  {
    ...
    testBelow = new LeafLabeledDouble(label, 78.0);
    testEqual = new LeafLabeledDouble(label, 85.0);
    testAbove = new LeafLabeledDouble(label, 90.0);
  }
  ...
  void testAdd()
  {
    LeafLabeledDouble ld = new LeafLabeledDouble("Hello", 90.0);
  ...
  void testGetValue() throws SizeException
  {
    ...
    LeafLabeledDouble value1 = new LeafLabeledDouble(label, 2.5);
    LeafLabeledDouble value2 = new LeafLabeledDouble(label, 2.5);

    this.historyTest.add(value1);
    this.historyTest.add(value2);

    LeafLabeledDouble result = this.historyTest.getValue();
