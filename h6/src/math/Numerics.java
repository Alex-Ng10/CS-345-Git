...
public class Numerics
{
  ...
  /**
   * Return the given missing value if the given Double is null or its double value is less than the
   * given bound. Otherwise return its double value.
   * 
   * @param number
   *          The number to check
   * @param missingValue
   *          The value to use in place of missing
   * @param lowerBound
   *          The lower bound of valid values
   * @return The appropriate double value
   */
  public static double doubleValueOf(final Double number, final double missingValue,
