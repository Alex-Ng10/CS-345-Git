...
public class WeightedAverageCalculator implements Calculator {
   ...
   * 
   * @param weights A map where the key is a label and the value is the corresponding weight
   */
   ...
   * @param data A list of LabeledDouble objects to be averaged
   * @return A LabeledDouble representing the weighted average
   * @throws SizeException If the data list is null
   ...
   * 
   * @param data A list of LabeledDouble objects to be processed
