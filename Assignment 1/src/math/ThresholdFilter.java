...
/**
 * A filter for selecting LabeledDouble objects based on
 * a threshold value and comparison signs
 * 
 * The ThresholdFilter class filters a list of LabeledDouble objects 
 * which are defined by comparison signs and a threshold value
 * 
 * @author Alex Nguyen
 */
public class ThresholdFilter implements Filter {
   ...
   * @param sign An array of integers representing the conditions 
   */
